...
namespace Hamster.States
{
    class LevelFinished : BaseState
    {
        ...
        public override void Initialize()
        {
            ...
            //For the purpose of the workshop, this function will be disabled. The developer can integrate the leaderboard optionally
        ...
        public override void Resume(StateExitValue results)
        {
            ...
            dialogComponent.SubmitButton.gameObject.SetActive(false);
        }
        ...
        public override void HandleUIEvent(GameObject source, object eventData)
        {
            ...
            {
                FirebaseAnalytics.LogEvent("level_retry", "map_name", CommonData.gameWorld.worldMap.mapId);

...
namespace Hamster.States
{
    public class Gameplay : BaseState
    {
        ...
        public override void Initialize()
        {
            ...
            Time.timeScale = 1.0f;
            double gravity_y = FirebaseRemoteConfig.DefaultInstance.GetValue("gravity").DoubleValue;
        ...
        void SpawnReplayAnimator()
        {
            ...
            GameObject replayObj =
              UnityEngine.Object.Instantiate(CommonData.prefabs.lookup[replayPrefabID].prefab) as GameObject;
            if (replayObj != null)
            {

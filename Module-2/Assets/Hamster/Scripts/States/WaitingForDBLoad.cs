...
namespace Hamster.States
{
    ...
    class WaitingForDBLoad<T> : BaseState where T : class
    {
        ...
        {
            CommonData.app.Options.DatabaseUrl = new System.Uri("https://gbt-firebase-default-rtdb.firebaseio.com");
            database = FirebaseDatabase.DefaultInstance;

            FirebaseDatabase.DefaultInstance.GetReference(path).ValueChanged += HandleResult;

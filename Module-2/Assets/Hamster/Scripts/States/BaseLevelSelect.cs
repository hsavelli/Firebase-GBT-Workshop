...
namespace Hamster.States
{
    class BaseLevelSelect : BaseState
    {
        ...
        void ClearCurrentButtons()
        {
            ...
            //for the purpose of this workshop, this function will be disabled, and developers can code their leaderboard optionally
        ...
        public override void HandleUIEvent(GameObject source, object eventData)
        {
            ...
            {
                FirebaseAnalytics.LogEvent("map_select", "map_name", levelNames[mapSelection]);
